...
namespace Discount.Grpc.Services
{
    public class DiscountService : DiscountProtoService.DiscountProtoServiceBase
    {
        ...
        public override async Task<CouponModel> GetDiscount(GetDiscountRequest request, ServerCallContext context)
        {
            ...
            _logger.LogInformation($"Discountis retrieved for ProductName: {coupon.ProductName}, Amount: {coupon.Amount}");
        ...
        public override async Task<DeleteDiscountResponse> DeleteDuscount(DeleteDiscountRequest request, ServerCallContext context)
        {
